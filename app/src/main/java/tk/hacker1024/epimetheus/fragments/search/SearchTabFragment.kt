...
internal class SearchTabViewModel : ViewModel() {
    var pagedList: PagedList<PandoraData>? = null
}

internal abstract class SearchTabFragment<T : PandoraData>(private val searchType: SearchType) : androidx.fragment.app.Fragment() {
    internal companion object {
        inline fun <reified F : SearchTabFragment<*>> newInstance(query: String): F {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        view.list.apply {
            ...
            GlobalScope.launch {
                ...
                activity?.runOnUiThread {
                    @Suppress("UNCHECKED_CAST")
                    this@SearchTabFragment.adapter.submitList(viewModel.pagedList as PagedList<T>)
...
internal fun Songs.Companion.newInstance(query: String) = SearchTabFragment.newInstance<Songs>(query)
internal fun Artists.Companion.newInstance(query: String) = SearchTabFragment.newInstance<Artists>(query)
internal fun Albums.Companion.newInstance(query: String) = SearchTabFragment.newInstance<Albums>(query)
internal fun Playlists.Companion.newInstance(query: String) = SearchTabFragment.newInstance<Playlists>(query)
internal fun Stations.Companion.newInstance(query: String) = SearchTabFragment.newInstance<Stations>(query)